...
class Passages {
     ...
     *     })
     */
    list(sourceId, request = {}, requestOptions) {
    ...
    __list(sourceId_1) {
        return __awaiter(this, arguments, void 0, function* (sourceId, request = {}, requestOptions) {
            ...
            if (_response.ok) {
                return {
                    data: serializers.sources.passages.list.Response.parseOrThrow(_response.body, {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.LettaTimeoutError("Timeout exceeded when calling GET /v1/sources/{source_id}/passages.");
                case "unknown":
                    throw new errors.LettaError({
