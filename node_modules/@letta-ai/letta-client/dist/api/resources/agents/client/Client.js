...
const Client_11 = require("../resources/memoryVariables/client/Client");
class Agents {
    ...
    get memoryVariables() {
        var _a;
        return ((_a = this._memoryVariables) !== null && _a !== void 0 ? _a : (this._memoryVariables = new Client_11.MemoryVariables(this._options)));
    }
    /**
    ...
    __importFile(file, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            ...
            if (request.overrideEmbeddingHandle != null) {
                _request.append("override_embedding_handle", request.overrideEmbeddingHandle);
            }
            ...
            const _response = yield ((_a = this._options.fetcher) !== null && _a !== void 0 ? _a : core.fetcher)({
                ...
                headers: Object.assign(Object.assign(Object.assign({ "X-Project": (yield core.Supplier.get(this._options.project)) != null
                        ? yield core.Supplier.get(this._options.project)
                        : undefined, "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "@letta-ai/letta-client", "X-Fern-SDK-Version": "0.0.68665", "User-Agent": "@letta-ai/letta-client/0.0.68665", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version, "x-override-embedding-model": request.overrideEmbeddingModel != null ? request.overrideEmbeddingModel : undefined }, (yield this._getCustomAuthorizationHeaders())), _maybeEncodedRequest.headers), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers),
                requestType: "file",
