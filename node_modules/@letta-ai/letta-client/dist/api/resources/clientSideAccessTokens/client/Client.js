...
class ClientSideAccessTokens {
    ...
    __clientSideAccessTokensListClientSideAccessTokens() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            if (_response.ok) {
                return {
                    data: serializers.ClientSideAccessTokensListClientSideAccessTokensResponse.parseOrThrow(_response.body, {
