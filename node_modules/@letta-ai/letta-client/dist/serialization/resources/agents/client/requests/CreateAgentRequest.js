...
const CreateBlock_1 = require("../../../../types/CreateBlock");
const CreateAgentRequestToolRulesItem_1 = require("../../types/CreateAgentRequestToolRulesItem");
...
exports.CreateAgentRequest = core.serialization.object({
    ...
    toolRules: core.serialization.property("tool_rules", core.serialization.list(CreateAgentRequestToolRulesItem_1.CreateAgentRequestToolRulesItem).optional()),
