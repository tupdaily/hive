...
exports.LettaSerializeSchemasPydanticAgentSchemaMessageSchema = void 0;
const core = __importStar(require("../../core"));
const LettaMessageContentUnion_1 = require("./LettaMessageContentUnion");
exports.LettaSerializeSchemasPydanticAgentSchemaMessageSchema = core.serialization.object({
    createdAt: core.serialization.property("created_at", core.serialization.string()),
    groupId: core.serialization.property("group_id", core.serialization.string().optional()),
    model: core.serialization.string().optional(),
    name: core.serialization.string().optional(),
    role: core.serialization.string(),
    content: core.serialization.list(LettaMessageContentUnion_1.LettaMessageContentUnion),
